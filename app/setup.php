...
add_action('widgets_init', function () {
    register_widget(Widgets\Recent_Sidebar_Posts_Widget::class);
    register_widget(Widgets\Recent_Sidebar_Mini_Posts_Widget::class);
    ...
    register_sidebar([
        'name' => __('Footer', 'sage'),
        'id' => 'sidebar-footer',
        'before_widget' => '<div class="copyright %1$s %2$s">',
        'after_widget' => '</div>',
    ]);
});
